...
{{-- <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="https://hkinfrastruktur.com/file/2023/12/Logo-HKI-1-e1703085110638.png" class="max-h-24" alt="HKI Logo" />
          <span class="self-center text-2xl font-semibold whitespace-nowrap text-logo-blue">Hutama Karya Insfrastruktur</span>
      </a>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        tidak punya akun? <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Daftar</a>
                    </p>
                </form>
            </div>
        </div>
